...
**AQ-WEB-1.1.2** · Autoridade para medidas. Layout fluido entre os intervalos abaixo; não escalar uma captura Figma como imagem.
...
navegação interna usa duas subcolunas inclusive quando os três blocos principais
se reorganizam segundo a tabela; os alvos permanecem com no mínimo 44 px.
